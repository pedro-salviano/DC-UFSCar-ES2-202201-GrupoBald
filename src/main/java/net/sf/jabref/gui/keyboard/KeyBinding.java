...
public enum KeyBinding {
    ...
    AUTOMATICALLY_LINK_FILES("Automatically link files", Localization.lang("Automatically set file links"), "alt F"),
    BACK("Back", Localization.lang("Back"), "alt LEFT"),
    CLEANUP("Cleanup", Localization.lang("Cleanup entries"), "ctrl shift F7"),
    ...
    COPY_BIBTEX_KEY_AND_TITLE("Copy BibTeX key and title", Localization
            .lang("Copy BibTeX key and title"), "ctrl shift alt K"),
    ...
    ENTRY_EDITOR_NEXT_ENTRY("Entry editor, next entry", Localization
            .lang("Entry editor, next entry"), "ctrl shift DOWN"),
    ENTRY_EDITOR_NEXT_PANEL("Entry editor, next panel", Localization.lang("Entry editor, next panel"), "ctrl TAB"),
    ENTRY_EDITOR_NEXT_PANEL_2("Entry editor, next panel 2", Localization
            .lang("Entry editor, next panel 2"), "ctrl PLUS"),
    ENTRY_EDITOR_PREVIOUS_ENTRY("Entry editor, previous entry", Localization
            .lang("Entry editor, previous entry"), "ctrl shift UP"),
    ENTRY_EDITOR_PREVIOUS_PANEL("Entry editor, previous panel", Localization
            .lang("Entry editor, previous panel"), "ctrl shift TAB"),
    ENTRY_EDITOR_PREVIOUS_PANEL_2("Entry editor, previous panel 2", Localization
            .lang("Entry editor, previous panel 2"), "ctrl MINUS"),
    ENTRY_EDITOR_STORE_FIELD("Entry editor, store field", Localization.lang("Entry editor, store field"), "alt S"),
    FILE_LIST_EDITOR_MOVE_ENTRY_DOWN("File list editor, move entry down", Localization
            .lang("File list editor, move entry down"), "ctrl DOWN"),
    FILE_LIST_EDITOR_MOVE_ENTRY_UP("File list editor, move entry up", Localization
            .lang("File list editor, move entry up"), "ctrl UP"),
    ...
    IMPORT_INTO_CURRENT_DATABASE("Import into current database", Localization
            .lang("Import into current database"), "ctrl I"),
    ...
    OPEN_DATABASE("Open database bla", Localization.lang("Open database"), "ctrl O"),
    ...
    PREAMBLE_EDITOR_STORE_CHANGES("Preamble editor, store changes", Localization
            .lang("Preamble editor, store changes"), "alt S"),
    ...
    RESOLVE_DUPLICATE_BIBTEX_KEYS("Resolve duplicate BibTeX keys", Localization
            .lang("Resolve duplicate BibTeX keys"), "ctrl shift D"),
    ...
    STRING_DIALOG_REMOVE_STRING("String dialog, remove string", Localization
            .lang("String dialog, remove string"), "shift DELETE"),
